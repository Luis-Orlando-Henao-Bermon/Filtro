...
Algoritmo Ejercicio5_HenaoLuis
	...
	//------------------------------------------------------------------------------------------------
	x=0
	Para c<-0 Hasta a-1 Hacer //si la nota final del estudiante en esa posicion es mayor que x se remplaza x por dicha notafinal y asi hasta conseguir la nota mas alta
